...
urlpatterns = [
    ...
    path("<str:code>/cancha_confirmar_modificar/", cancha_confirm, name = 'cancha_confirmUpdate'),
    ...
    path("<str:code>/medico_confirmar_modificar/", medico_confirm, name = 'medico_confirmUpdate'),
